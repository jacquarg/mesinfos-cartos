...
buf.push("</div>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 4, "templatedetail.jade" ));
buf.push("<div class=\"usecase\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 5, "templatedetail.jade" ));
buf.push("<a" + (jade.attr("href", Website, true, false)) + ">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 6, "templatedetail.jade" ));
buf.push("<img" + (jade.attr("src", Website + 'favicon.ico', true, false)) + "/>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 7, "templatedetail.jade" ));
buf.push("<h1 class=\"textfill\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 8, "templatedetail.jade" ));
...
buf.push("</a>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 10, "templatedetail.jade" ));
if ( status !== 'operational')
{
jade_debug.unshift(new jade.DebugItem( 11, "templatedetail.jade" ));
jade_debug.unshift(new jade.DebugItem( 11, "templatedetail.jade" ));
buf.push("<div class=\"status\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 12, "templatedetail.jade" ));
...
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 14, "templatedetail.jade" ));
buf.push("<div class=\"countries\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 15, "templatedetail.jade" ));
// iterate countries
;(function(){
  var $$obj = countries;
...
jade_debug.unshift(new jade.DebugItem( 15, "templatedetail.jade" ));
jade_debug.unshift(new jade.DebugItem( 16, "templatedetail.jade" ));
...
buf.push("</div>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 18, "templatedetail.jade" ));
buf.push("<div class=\"usecase-main\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 19, "templatedetail.jade" ));
if ( Slogan___Tweet_length_description)
{
jade_debug.unshift(new jade.DebugItem( 20, "templatedetail.jade" ));
jade_debug.unshift(new jade.DebugItem( 20, "templatedetail.jade" ));
buf.push("<div class=\"slogan textfill\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 21, "templatedetail.jade" ));
...
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 23, "templatedetail.jade" ));
buf.push("<h3>");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
buf.push("</h3>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 24, "templatedetail.jade" ));
buf.push("<div class=\"descriptioncontainer\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 25, "templatedetail.jade" ));
if ( Long_description)
{
jade_debug.unshift(new jade.DebugItem( 26, "templatedetail.jade" ));
jade_debug.unshift(new jade.DebugItem( 26, "templatedetail.jade" ));
buf.push("<div class=\"description textfill\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 27, "templatedetail.jade" ));
...
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 29, "templatedetail.jade" ));
if ( Who_offers__or_could_offer__the_service_)
{
jade_debug.unshift(new jade.DebugItem( 30, "templatedetail.jade" ));
jade_debug.unshift(new jade.DebugItem( 30, "templatedetail.jade" ));
buf.push("<div class=\"whooffers\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 31, "templatedetail.jade" ));
...
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 32, "templatedetail.jade" ));
buf.push("<span>");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 33, "templatedetail.jade" ));
...
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 35, "templatedetail.jade" ));
if ( Where_is_the_economic_value___What_is_the_business_model_)
{
jade_debug.unshift(new jade.DebugItem( 36, "templatedetail.jade" ));
jade_debug.unshift(new jade.DebugItem( 36, "templatedetail.jade" ));
buf.push("<div class=\"businessmodel\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 37, "templatedetail.jade" ));
buf.push("<span class=\"h4\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 38, "templatedetail.jade" ));
buf.push("<span>");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 39, "templatedetail.jade" ));
...
buf.push("</div>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 41, "templatedetail.jade" ));
buf.push("<div class=\"usecase-right\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 42, "templatedetail.jade" ));
buf.push("<h3>");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
buf.push("</h3>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 43, "templatedetail.jade" ));
buf.push("<div class=\"domains\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 44, "templatedetail.jade" ));
buf.push("<img" + (jade.attr("src", 'img/usecases/'+ domain + '.jpg', true, false)) + (jade.attr("title", Use_Case_category, true, false)) + "/>");
jade_debug.shift();
jade_debug.shift();
buf.push("</div>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 46, "templatedetail.jade" ));
if ( tags)
{
jade_debug.unshift(new jade.DebugItem( 47, "templatedetail.jade" ));
jade_debug.unshift(new jade.DebugItem( 47, "templatedetail.jade" ));
buf.push("<h3>");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
buf.push("</h3>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 48, "templatedetail.jade" ));
buf.push("<div class=\"tags textfill\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 49, "templatedetail.jade" ));
...
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 51, "templatedetail.jade" ));
buf.push("<h3>");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
...
buf.push("</h3>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 52, "templatedetail.jade" ));
buf.push("<div class=\"website textfill\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 53, "templatedetail.jade" ));
buf.push("<span>" + (jade.escape(null == (jade_interp = Website) ? "" : jade_interp)));
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.shift();
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 55, "templatedetail.jade" ));
if ( Link_file_if_necessary)
{
jade_debug.unshift(new jade.DebugItem( 56, "templatedetail.jade" ));
jade_debug.unshift(new jade.DebugItem( 56, "templatedetail.jade" ));
