...
;pug_debug_line = 4;pug_debug_filename = "ideationcard.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = Nom) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
;pug_debug_line = 5;pug_debug_filename = "ideationcard.pug";
pug_html = pug_html + "\u003Cimg" + (" class=\"holder\""+pug_attr("src", "img/creationcard/logo_" + Détenteur.toLowerCase() + ".png", true, false)+pug_attr("title", Détenteur, true, false)) + "\u002F\u003E";
...
;pug_debug_line = 7;pug_debug_filename = "ideationcard.pug";
pug_html = pug_html + "\u003Cdiv class=\"frequency\"\u003E";
;pug_debug_line = 8;pug_debug_filename = "ideationcard.pug";
pug_html = pug_html + "\u003Cimg src=\"img\u002Fcreationcard\u002Ffrequency_gauge.svg\"\u002F\u003E";
;pug_debug_line = 9;pug_debug_filename = "ideationcard.pug";
pug_html = pug_html + "\u003Cspan\u003E";
;pug_debug_line = 9;pug_debug_filename = "ideationcard.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = Fréquence) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
;pug_debug_line = 10;pug_debug_filename = "ideationcard.pug";
pug_html = pug_html + "\u003Cdiv class=\"index\"\u003E";
;pug_debug_line = 10;pug_debug_filename = "ideationcard.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = index) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"Description" in locals_for_with?locals_for_with.Description:typeof Description!=="undefined"?Description:undefined,"Détenteur" in locals_for_with?locals_for_with.Détenteur:typeof Détenteur!=="undefined"?Détenteur:undefined,"Fréquence" in locals_for_with?locals_for_with.Fréquence:typeof Fréquence!=="undefined"?Fréquence:undefined,"Nom" in locals_for_with?locals_for_with.Nom:typeof Nom!=="undefined"?Nom:undefined,"Typologie" in locals_for_with?locals_for_with.Typologie:typeof Typologie!=="undefined"?Typologie:undefined,"index" in locals_for_with?locals_for_with.index:typeof index!=="undefined"?index:undefined,"typologyColor" in locals_for_with?locals_for_with.typologyColor:typeof typologyColor!=="undefined"?typologyColor:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}